...
class ActiveRecord::Base
  ...
  def self.owns_one detail_type, class_name
    association_name = :"#{detail_type}_detail"
    ...
    reflect_on_association(association_name).klass.tap do |k|
      ...
      k.reflect_on_all_associations.reject{|a| a.macro==:belongs_to && a.name==detail_type }.each do |a|
